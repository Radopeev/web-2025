...
<link rel="stylesheet" href="<?php echo BASE_PATH; ?>/public/styles/landing_page_styles.css">
...
<main class="main-container">
    ...
    <section class="search-section">
        <form action="<?php echo BASE_PATH; ?>/landingPage" method="GET" class="search-form">
            <input
                type="search"
                name="search"
                ...
                <?php foreach ($projects as $project): ?>
                    <div class="project-card">
                        ...
                        <div class="project-actions">
                            <a href="<?php echo BASE_PATH; ?>/project/details?id=<?php echo htmlspecialchars($project['id']); ?>" class="details-link">
                                View Details &rarr;
                            </a>
                            <?php
